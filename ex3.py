...
def g_data(amm):
    ...
    for i in range(amm):
        ...
        if i>1:
            m=  x[i-1][3]+x[i-2][3]
            # '''
        x[i]=[i,i,i,i,i] #norm,norm,geometric,fibinacci,exponential
    return x
